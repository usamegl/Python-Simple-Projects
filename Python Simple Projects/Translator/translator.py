...
def translate_now():
    ...
    try:
        ...
        messagebox.showerror("Arch's translator","please try again")

#icon 
image_icon=PhotoImage(file="arch.png")
root.iconphoto(False, image_icon)

#arrow
#arrow_image=PhotoImage(file="arrowx.png")
